...
{
    public class ZzzAddress : Address, IAddress
    {
        public override string AddressString { get; protected set; }

        public override ushort AddressId { get; protected set; }

        public override string HardwareAcronym => "ZZZ";

        public override string HardwareDescription => "Unknown Hardware";
        ...
        public AddressFactory.HardwareType HardwareType => AddressFactory.HardwareType.UnknownHardware;
    }
}