...
namespace Common
{
    ...
    public class AttrCollection<K, L, V>
    {
        ...
        public V this[L subKey]
        {
            get
            {
                ...
                {
                    RsLog.LogMessage(LogEventType.Warn, OriginatorType.System, "Server",
                        "Configuration", "Error processing configuration - " + "Key not found: " + subKey.ToString());
                }
        ...
        public V this[K primaryKey]
        {
            get
            {
                ...
                {
                    RsLog.LogMessage(LogEventType.Warn, OriginatorType.System, "Server",
                        "Configuration", "Error processing configuration - " + "Key not found: " + primaryKey.ToString());
                }
        ...
        public void Associate(L subKey, K primaryKey)
        {
            ...
            try
            {
                ...
                {
                    RsLog.LogMessage(LogEventType.Warn, OriginatorType.System, "Server",
                        "Configuration", "Error processing configuration - " + "The base dictionary does not contain the key: " + primaryKey.ToString());
        ...
        public void Update(K primaryKey, V val)
        {
            var subKey = primaryToSubkeyMapping[primaryKey];
            Remove(primaryKey);
            
            Add(primaryKey, subKey, val);
        }

        public void Update(L subKey, V val)
        {
            var primaryKey = subDictionary[subKey];
            Remove(subKey);
